...
export const HYPERSIGN_SERVICE_BASE_URL_FORMAT = process.env.NODE_ENV == "production" ? 'https://<subdomain>.api.cavach.hypersign.id/api/v1' : 'https://<subdomain>.api.cavach.hypersign.id/api/v1'
