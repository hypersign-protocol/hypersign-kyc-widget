  ...
  async created() {
    ...
    if (WidgetConfig) {
      ...
      let steps = [
        ...
        { "id": 5, "isActive": false, "stepName": "ZkProofs", "name": "Generate Proofs", "previous": 4, "isEnabled": false },
        // { "id": 6, "isActive": false, "stepName": "OnChainId4", "name": "On Chain Identity", "previous": 5, "isEnabled": false },
