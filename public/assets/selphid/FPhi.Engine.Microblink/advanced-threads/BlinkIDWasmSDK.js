...
*/
    ...
    var D;
    D || (D = typeof BlinkIDWasmSDK !== "undefined" ? BlinkIDWasmSDK : {});
    var ma, na;
      ...
      (function (a) {
        function b(m, n, q) {
          ...
          p.onprogress = function (r) {
            ...
            if (r.loaded) {
              p.Wc
                ? (D.Kb[m].loaded = r.loaded)
                : ((p.Wc = !0),
                  D.Kb || (D.Kb = {}),
                  (D.Kb[m] = { loaded: r.loaded, total: k }));
              var t = (k = r = 0),
                x;
              for (x in D.Kb) {
                var A = D.Kb[x];
              ...
              r = Math.ceil((r * D.kc) / t);
              D.setStatus &&
                D.setStatus("Downloading data... (" + k + "/" + r + ")");
            } else !D.Kb && D.setStatus && D.setStatus("Downloading data...");
          };
          p.onerror = function () {
        ...
        function d() {
          ...
          function n(r) {
            ...
            for (var k = 0; k < r.length; ++k)
              m.prototype.uc[r[k].filename].onload();
            D.removeRunDependency(
              "datafile_/opt/jenkins/android-arm64-huawei-p30-pro/root/E0/sdk-blinkid-in-browser/resources/advanced-threads/BlinkIDWasmSDK.data",
            );
          }
          ...
          D.Kc || (D.Kc = {});
          D.Kc[
            "/opt/jenkins/android-arm64-huawei-p30-pro/root/E0/sdk-blinkid-in-browser/resources/advanced-threads/BlinkIDWasmSDK.data"
          ] = { ae: !1 };
          l ? (n(l), (l = null)) : (h = n);
        }
        ...
        var e = D.locateFile
            ? D.locateFile("BlinkIDWasmSDK.data", "")
            : "BlinkIDWasmSDK.data",
    ...
    var oa = Object.assign({}, D),
      ...
      ta =
        ...
        "object" == typeof process.Zd &&
        "string" == typeof process.Zd.node,
      F = D.ENVIRONMENT_IS_PTHREAD || !1,
      ua = "";
    function va(a) {
      return D.locateFile ? D.locateFile(a, ua) : ua + a;
    }
    var wa, xa, ya;
    if (ra || sa)
      sa
    ...
    var za = D.print || console.log.bind(console),
    ...
    D.quit && (qa = D.quit);
    var Aa;
    D.wasmBinary && (Aa = D.wasmBinary);
    var noExitRuntime = D.noExitRuntime || !1;
    "object" != typeof WebAssembly && Ba("no native wasm support detected");
    var u,
      Ca,
      Da = !1,
      Ea,
    ...
    var La = D.INITIAL_MEMORY || 209715200;
    5242880 <= La ||
      Ba(
    ...
    function Ua() {
      F ||
        (D.noFSInit ||
          ...
          (D.stdout = D.stdout),
          (D.stderr = D.stderr),
          D.stdin ? Xa("/dev", "stdin", D.stdin) : Ya("/dev/tty", "/dev/stdin"),
          D.stdout
            ? Xa("/dev", "stdout", null, D.stdout)
            : Ya("/dev/tty", "/dev/stdout"),
          D.stderr
            ? Xa("/dev", "stderr", null, D.stderr)
            : Ya("/dev/tty1", "/dev/stderr"),
          Za("/dev/stdin", 0),
          Za("/dev/stdout", 1),
          Za("/dev/stderr", 1)),
        ($a = !1),
    ...
    function hb() {
      eb++;
      D.monitorRunDependencies && D.monitorRunDependencies(eb);
    }
    function ib() {
      eb--;
      D.monitorRunDependencies && D.monitorRunDependencies(eb);
    ...
    var kb;
    kb = "BlinkIDWasmSDK.wasm";
    jb(kb) || (kb = va(kb));
    function lb(a) {
      try {
        if (a == kb && Aa) return new Uint8Array(Aa);
        if (ya) return ya(a);
    ...
    function mb(a) {
      return Aa || (!ra && !sa) || "function" != typeof fetch
    ...
    function tb(a) {
      ...
      b.Ab = a.Ab;
      b.postMessage(
        { cmd: "run", start_routine: a.Sd, arg: a.Xc, pthread_ptr: a.Ab },
        a.Xd,
      );
      return 0;
    }
    ...
    var Eb = {
        ...
        read: function (a, b, c, d) {
          if (!a.nb || !a.nb.Ob.Gc) throw new N(60);
          for (var e = 0, f = 0; f < d; f++) {
            try {
              var h = a.nb.Ob.Gc(a.nb);
            } catch (l) {
              throw new N(29);
            }
        ...
        write: function (a, b, c, d) {
          if (!a.nb || !a.nb.Ob.qc) throw new N(60);
          try {
            for (var e = 0; e < d; e++) a.nb.Ob.qc(a.nb, b[c + e]);
          } catch (f) {
            throw new N(29);
          }
      ...
      Fb = {
        ...
        Zb: function (a) {
          a.pb && 0 < a.pb.length && (za(Ga(a.pb, 0)), (a.pb = []));
        },
      },
      Gb = {
        qc: function (a, b) {
        ...
        Zb: function (a) {
          a.pb && 0 < a.pb.length && (E(Ga(a.pb, 0)), (a.pb = []));
        },
      };
    function Hb(a) {
      ...
      createNode: function (a, b, c, d) {
        ...
        O.xb ||
          (O.xb = {
            ...
            link: {
              node: { wb: O.hb.wb, sb: O.hb.sb, Ub: O.hb.Ub },
              stream: {},
            },
            Ac: { node: { wb: O.hb.wb, sb: O.hb.sb }, stream: Jb },
          });
        c = Kb(a, b, c, d);
        16384 === (c.mode & 61440)
          ? ((c.hb = O.xb.dir.node), (c.ib = O.xb.dir.stream), (c.gb = {}))
          : 32768 === (c.mode & 61440)
            ? ((c.hb = O.xb.file.node),
              (c.ib = O.xb.file.stream),
              (c.lb = 0),
              (c.gb = null))
            : 40960 === (c.mode & 61440)
              ? ((c.hb = O.xb.link.node), (c.ib = O.xb.link.stream))
              : 8192 === (c.mode & 61440) &&
                ((c.hb = O.xb.Ac.node), (c.ib = O.xb.Ac.stream));
        c.timestamp = Date.now();
        a && ((a.gb[b] = c), (a.timestamp = c.timestamp));
        return c;
      },
      be: function (a) {
        return a.gb
          ? a.gb.subarray
            ? a.gb.subarray(0, a.lb)
            : new Uint8Array(a.gb)
          : new Uint8Array(0);
      },
      Dc: function (a, b) {
        var c = a.gb ? a.gb.length : 0;
        c >= b ||
          ((b = Math.max(b, (c * (1048576 > c ? 2 : 1.125)) >>> 0)),
          0 != c && (b = Math.max(b, 256)),
          (c = a.gb),
          (a.gb = new Uint8Array(b)),
          0 < a.lb && a.gb.set(c.subarray(0, a.lb), 0));
      },
      Ed: function (a, b) {
        if (a.lb != b)
          if (0 == b) (a.gb = null), (a.lb = 0);
          else {
            var c = a.gb;
            a.gb = new Uint8Array(b);
            c && a.gb.set(c.subarray(0, Math.min(b, a.lb)));
            a.lb = b;
          }
      },
      hb: {
            ...
            16384 === (a.mode & 61440)
              ...
              : 32768 === (a.mode & 61440)
                ...
                : 40960 === (a.mode & 61440)
                  ? a.link.length
                  : 0;
          b.Yc = new Date(a.timestamp);
          b.yd = new Date(a.timestamp);
          b.cd = new Date(a.timestamp);
          b.Zc = 4096;
          b.$c = Math.ceil(b.size / b.Zc);
          return b;
        },
        sb: function (a, b) {
          void 0 !== b.mode && (a.mode = b.mode);
          void 0 !== b.timestamp && (a.timestamp = b.timestamp);
          void 0 !== b.size && O.Ed(a, b.size);
        },
        Pb: function () {
          throw Lb[44];
        },
        ...
        Oc: function (a, b, c) {
          if (16384 === (a.mode & 61440)) {
            ...
            if (d) for (var e in d.gb) throw new N(55);
          }
        ...
        Nc: function (a) {
          var b = [".", ".."],
            c;
          for (c in a.gb) a.gb.hasOwnProperty(c) && b.push(c);
          return b;
        },
        fc: function (a, b, c) {
      ...
      ib: {
        ...
        write: function (a, b, c, d, e, f) {
          ...
          if (b.subarray && (!a.gb || a.gb.subarray)) {
            if (f) return (a.gb = b.subarray(c, c + d)), (a.lb = d);
            if (0 === a.lb && 0 === e)
              return (a.gb = b.slice(c, c + d)), (a.lb = d);
            if (e + d <= a.lb) return a.gb.set(b.subarray(c, c + d), e), d;
          }
          O.Dc(a, e + d);
        ...
        Gb: function (a, b, c) {
          1 === c
            ? (b += a.position)
            : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.lb);
          if (0 > b) throw new N(28);
          return b;
        },
        wc: function (a, b, c) {
          O.Dc(a.node, b + c);
          a.node.lb = Math.max(a.node.lb, b + c);
        },
    ...
    function Nb(a, b, c) {
      ...
      xa(
        a,
        (e) => {
          e || Ba('Loading data file "' + a + '" failed (no arrayBuffer).');
          b(new Uint8Array(e));
          d && ib(d);
        },
        () => {
    ...
    var Ob = null,
      ...
      Ub = (a, b = {}) => {
        ...
        b = Object.assign({ Fc: !0, sc: 0 }, b);
        if (8 < b.sc) throw new N(32);
        ...
        for (var c = Ob, d = "/", e = 0; e < a.length; e++) {
          ...
          c = Mb(c, a[e]);
          d = vb(d + "/" + a[e]);
          c.Rb && (!f || (f && b.Fc)) && (c = c.Rb.root);
          if (!f || b.Yb)
            for (f = 0; 40960 === (c.mode & 61440); )
              if (
                ((c = Tb(d)),
                (d = zb(wb(d), c)),
                (c = Ub(d, { sc: b.sc + 1 }).node),
                40 < f++)
              )
                throw new N(32);
        }
      ...
      Mb = (a, b) => {
        var c;
        if ((c = (c = Xb(a, "x")) ? c : a.hb.Pb ? 0 : 2)) throw new N(c, a);
        for (c = Sb[Wb(a.id, b)]; c; c = c.Nb) {
          var d = c.name;
      ...
      Jb = {
        open: (a) => {
          a.ib = Pb[a.node.Tb].ib;
          a.ib.open && a.ib.open(a);
        },
        Gb: () => {
          throw new N(70);
        },
      ...
      ec = (a, b) => {
        ...
        a.zb = b;
        b.root = a;
        c ? (Ob = a) : e && ((e.Rb = b), e.zb && e.zb.xd.push(b));
      },
      P = (a, b, c) => {
        var d = Ub(a, { parent: !0 }).node;
        a = xb(a);
        if (!a || "." === a || ".." === a) throw new N(28);
        var e = ac(d, a);
        if (e) throw new N(e);
        if (!d.hb.cc) throw new N(63);
        return d.hb.cc(d, a, b, c);
      },
      fc = (a, b, c) => {
      ...
      Ya = (a, b) => {
        if (!zb(a)) throw new N(44);
        var c = Ub(b, { parent: !0 }).node;
        if (!c) throw new N(44);
        b = xb(b);
        var d = ac(c, b);
        if (d) throw new N(d);
        if (!c.hb.fc) throw new N(63);
        c.hb.fc(c, b, a);
      },
      gc = (a) => {
        var b = Ub(a, { parent: !0 }).node;
        if (!b) throw new N(44);
        var c = xb(a);
        a = Mb(b, c);
        a: {
        ...
        if (d) throw new N(d);
        if (!b.hb.jc) throw new N(63);
        if (a.Rb) throw new N(10);
        b.hb.jc(b, c);
        b = Wb(a.parent.id, a.name);
        if (Sb[b] === a) Sb[b] = a.Nb;
        else
      ...
      Tb = (a) => {
        a = Ub(a).node;
        if (!a) throw new N(44);
        if (!a.hb.Ub) throw new N(28);
        return zb(Vb(a.parent), a.hb.Ub(a));
      },
      hc = (a, b) => {
        a = Ub(a, { Yb: !b }).node;
        if (!a) throw new N(44);
        if (!a.hb.wb) throw new N(63);
        return a.hb.wb(a);
      },
      ic = (a) => hc(a, !0),
      jc = (a, b) => {
        a = "string" == typeof a ? Ub(a, { Yb: !0 }).node : a;
        if (!a.hb.sb) throw new N(63);
        a.hb.sb(a, {
      ...
      Za = (a, b, c) => {
        ...
        if (
          ...
          (c = e
            ? 40960 === (e.mode & 61440)
              ? 32
              : 16384 === (e.mode & 61440) && ("r" !== $b(b) || b & 512)
                ? 31
                : Xb(e, $b(b))
            : 44)
        )
        ...
        !D.logReadFiles || b & 1 || (kc || (kc = {}), a in kc || (kc[a] = 1));
        return e;
      },
      lc = (a) => {
        if (null === a.Db) throw new N(8);
        a.lc && (a.lc = null);
        try {
          a.ib.close && a.ib.close(a);
        } catch (b) {
          throw b;
        } finally {
          Qb[a.Db] = null;
      ...
      mc = (a, b, c) => {
        if (null === a.Db) throw new N(8);
        if (!a.seekable || !a.ib.Gb) throw new N(70);
        if (0 != c && 1 != c && 2 != c) throw new N(28);
        a.position = a.ib.Gb(a, b, c);
        a.Yd = [];
      },
      nc = (a, b, c, d, e, f) => {
        ...
        if (!a.ib.write) throw new N(28);
        a.seekable && a.flags & 1024 && mc(a, 0, 2);
        var h = "undefined" != typeof e;
        if (!h) e = a.position;
        else if (!a.seekable) throw new N(70);
        b = a.ib.write(a, b, c, d, e, f);
        h || (a.position += b);
        return b;
      },
      Wa = () => {
      ...
      sc = (a) => {
        if (!(a.td || a.ud || a.link || a.gb)) {
          ...
          if (wa)
            try {
              (a.gb = Ab(wa(a.url), !0)), (a.lb = a.gb.length);
            } catch (b) {
              throw new N(29);
            }
      ...
      tc = (a, b, c, d, e) => {
        ...
        f.prototype.get = function (p) {
          if (!(p > this.length - 1 || 0 > p)) {
            var r = p % this.Bc;
            return this.$b((p / this.Bc) | 0)[r];
          }
        };
        f.prototype.Gd = function (p) {
          this.$b = p;
        };
        f.prototype.zc = function () {
          ...
          A.Gd((G) => {
            var I = G * x,
              y = (G + 1) * x - 1;
            y = Math.min(y, r - 1);
            if ("undefined" == typeof A.Xb[G]) {
              var T = A.Xb;
              if (I > y)
                throw Error(
                  "invalid range (" + I + ", " + y + ") or no bytes requested!",
                );
              if (y > r - 1)
                throw Error(
              ...
              C.open("GET", c, !1);
              r !== x && C.setRequestHeader("Range", "bytes=" + I + "-" + y);
            ...
            if ("undefined" == typeof A.Xb[G]) throw Error("doXHR failed!");
            return A.Xb[G];
          });
          if (p || !r)
            (x = r = 1),
      ...
      vc = (a, b, c, d, e, f, h, l, m, n) => {
        ...
        var p = b ? zb(vb(a + "/" + b)) : a,
          r = "cp " + p;
        hb(r);
        "string" == typeof c ? Nb(c, (k) => q(k), h) : q(c);
      },
      Q = {},
      cc,
      kc;
    ...
    function yc(a, b, c) {
      try {
        ...
        if (f && f.node && vb(b) !== vb(Vb(f.node))) return -54;
        throw f;
      }
      z()[c >> 2] = d.fd;
      z()[(c + 8) >> 2] = d.nc;
    ...
    function Gc(a) {
      a instanceof qb || "unwind" == a || qa(1, a);
    }
    var M = {
      Eb: [],
      Hb: [],
      ...
      qd: function () {
        for (var a = navigator.hardwareConcurrency; a--; ) M.xc();
      },
      rd: function () {
        M.receiveObjectTransfer = M.Dd;
        M.threadInitTLS = M.Sc;
        M.setExitStatus = M.Qc;
        noExitRuntime = !1;
      },
      Qc: function (a) {
        Ea = a;
      ...
      Hc: (a) =>
        new Promise((b) => {
          a.onmessage = (f) => {
            ...
            var h = f.cmd;
            a.Ab && (M.dd = a.Ab);
            if (f.targetThread && f.targetThread != Ic()) {
              var l = M.Bb[f.fe];
              l
            ...
            } else if ("processProxyingQueue" === h) Jc(f.queue);
            else if ("spawnThread" === h) tb(f);
            else if ("cleanupThread" === h) sb(f.thread);
              ...
              (f = f.thread),
                ...
                rb(h),
                Hc(f),
                M.Hb.splice(M.Hb.indexOf(h), 1),
                (h.Ab = 0);
            else if ("cancelThread" === h)
              M.Bb[f.thread].postMessage({ cmd: "cancel" });
            else if ("loaded" === h) (a.loaded = !0), b(a);
            else if ("print" === h) za("Thread " + f.threadId + ": " + f.text);
            else if ("printErr" === h)
      ...
      wd: function (a) {
        if (F) return a();
        Promise.all(M.Eb.map(M.Hc)).then(a);
      },
      xc: function () {
        var a = va("BlinkIDWasmSDK.worker.js");
        a = new Worker(a);
        M.Eb.push(a);
      },
      kd: function () {
        0 == M.Eb.length && (M.xc(), M.Hc(M.Eb[0]));
        return M.Eb.pop();
      },
    };
    D.PThread = M;
    ...
    function S(a) {
      var b = Mc[a];
      b || (a >= Mc.length && (Mc.length = a + 1), (Mc[a] = b = Ma.get(a)));
      return b;
    }
    ...
    var Pc = 0;
    function Qc(a, b, c, d) {
      return F ? R(3, 1, a, b, c, d) : Rc(a, b, c, d);
    }
    function Rc(a, b, c, d) {
      ...
      var e = [];
      if (F && 0 === e.length) return Qc(a, b, c, d);
      a = { Sd: c, Ab: a, Xc: d, Xd: e };
      return F ? ((a.$d = "spawnThread"), postMessage(a, e), 0) : tb(a);
    }
    function Sc(a, b, c) {
      if (F) return R(4, 1, a, b, c);
      zc = c;
      try {
        var d = xc(a);
        switch (b) {
    ...
    function Tc(a, b) {
      if (F) return R(5, 1, a, b);
      try {
        var c = xc(a);
        return yc(hc, c.path, b);
      } catch (d) {
    ...
    function Uc(a, b, c) {
      ...
      try {
        ...
        switch (b) {
          ...
          case 21531:
            a = e = Ac();
            if (!d.ib.sd) throw new N(59);
            return d.ib.sd(d, b, a);
          case 21523:
            return d.nb ? 0 : -59;
          case 21524:
            return d.nb ? 0 : -59;
    ...
    function Vc(a, b) {
      if (F) return R(7, 1, a, b);
      try {
        return (a = H(a)), yc(ic, a, b);
      } catch (c) {
    ...
    function Wc(a, b, c, d) {
      if (F) return R(8, 1, a, b, c, d);
      try {
        b = H(b);
        var e = d & 256;
        b = wc(a, b, d & 4096);
        return yc(e ? ic : hc, b, c);
      } catch (f) {
        if ("undefined" == typeof Q || "ErrnoError" !== f.name) throw f;
        return -f.ob;
      }
    ...
    function Yc(a, b) {
      if (F) return R(10, 1, a, b);
      try {
        return (a = H(a)), yc(hc, a, b);
      } catch (c) {
        if ("undefined" == typeof Q || "ErrnoError" !== c.name) throw c;
        return -c.ob;
      }
    ...
    function kd(a, b, c) {
      function d(l) {
        l = c(l);
        l.length !== a.length && jd("Mismatched type converter count");
        for (var m = 0; m < a.length; ++m) ld(a[m], l[m]);
      }
    ...
    function ld(a, b, c = {}) {
      ...
      delete dd[a];
      bd.hasOwnProperty(a) &&
        ((b = bd[a]), delete bd[a], b.forEach((e) => e()));
    }
    function pd(a) {
      V(a.$a.mb.kb.name + " instance already deleted");
    }
    var qd = !1;
    function rd() {}
    function sd(a) {
      --a.count.value;
      0 === a.count.value && (a.rb ? a.tb.Cb(a.rb) : a.mb.kb.Cb(a.jb));
    }
    function td(a, b, c) {
      if (b === c) return a;
      if (void 0 === c.ub) return null;
      a = td(a, b, c.ub);
      return null === a ? null : c.gd(a);
    }
    var ud = {},
      vd = [];
    function wd() {
    ...
    var xd = void 0,
      yd = {};
    function zd(a, b) {
      for (void 0 === b && V("ptr should not be undefined"); a.ub; )
        (b = a.Vb(b)), (a = a.ub);
      return yd[b];
    }
    function Ad(a, b) {
      (b.mb && b.jb) || jd("makeClassHandle requires ptr and ptrType");
      !!b.tb !== !!b.rb &&
        jd("Both smartPtrType and smartPtr must be specified");
      b.count = { value: 1 };
      return Bd(Object.create(a, { $a: { value: b } }));
    }
    function Bd(a) {
      if ("undefined" === typeof FinalizationRegistry)
        return (Bd = (b) => b), a;
      qd = new FinalizationRegistry((b) => {
        sd(b.$a);
      });
      Bd = (b) => {
        var c = b.$a;
        c.rb && qd.register(b, { $a: c }, b);
        return b;
      };
      rd = (b) => {
        qd.unregister(b);
    ...
    function Dd(a, b, c) {
      if (void 0 === a[b].qb) {
        var d = a[b];
        a[b] = function () {
          a[b].qb.hasOwnProperty(arguments.length) ||
            V(
              "Function '" +
                c +
          ...
          return a[b].qb[arguments.length].apply(this, arguments);
        };
        a[b].qb = [];
        a[b].qb[d.Wb] = d;
      }
    ...
    function Ed(a, b, c) {
      D.hasOwnProperty(a)
        ? ((void 0 === c || (void 0 !== D[a].qb && void 0 !== D[a].qb[c])) &&
          ...
          (D[a].qb[c] = b))
        : ((D[a] = b), void 0 !== c && (D[a].de = c));
    }
    function Fd(a, b, c, d, e, f, h, l) {
      this.name = a;
      this.constructor = b;
      this.Mb = c;
      this.Cb = d;
    ...
    function Hd(a, b) {
      if (null === b)
        return this.oc && V("null is not a valid " + this.name), 0;
      b.$a || V('Cannot pass "' + Id(b) + '" as a ' + this.name);
      b.$a.jb ||
        V("Cannot pass deleted object as a pointer of type " + this.name);
      return Gd(b.$a.jb, b.$a.mb.kb, this.kb);
    }
    function Jd(a, b) {
      if (null === b) {
        this.oc && V("null is not a valid " + this.name);
        if (this.bc) {
          var c = this.rc();
          null !== a && a.push(this.Cb, c);
          return c;
        }
        return 0;
      }
      ...
      !this.ac &&
        ...
        V(
          "Cannot convert argument of type " +
            (b.$a.tb ? b.$a.tb.name : b.$a.mb.name) +
            " to parameter type " +
            this.name,
        );
      c = Gd(b.$a.jb, b.$a.mb.kb, this.kb);
      if (this.bc)
        switch (
          (void 0 === b.$a.rb &&
    ...
    function Ld(a, b, c, d) {
      ...
      this.ac = d;
      this.bc = !1;
      this.Cb = this.Cd = this.rc = this.Mc = this.Rd = this.Ad = void 0;
      void 0 !== b.ub
        ? (this.toWireType = Jd)
        : ((this.toWireType = d ? Hd : Kd), (this.vb = null));
    }
    function Md(a, b, c) {
      D.hasOwnProperty(a) || jd("Replacing nonexistant public symbol");
      void 0 !== D[a].qb && void 0 !== c
        ? (D[a].qb[c] = b)
        : ((D[a] = b), (D[a].Wb = c));
    }
    function Nd(a, b) {
      ...
      return function () {
        ...
        } else d = S(b).apply(null, c);
        return d;
      };
    }
    function Od(a, b) {
      a = U(a);
      var c = a.includes("j") ? Nd(a, b) : S(b);
      "function" != typeof c &&
    ...
    function Td(a, b) {
      function c(f) {
        e[f] || cd[f] || (dd[f] ? dd[f].forEach(c) : (d.push(f), (e[f] = !0)));
      }
      var d = [],
        e = {};
      b.forEach(c);
      throw new Pd(a + ": " + d.map(Qd).join([", "]));
    }
    function Ud(a, b) {
    ...
    function Xd(a) {
      4 < a && 0 === --X[a].tc && ((X[a] = void 0), Wd.push(a));
    }
    var Y = (a) => {
      ...
      W = (a) => {
        switch (a) {
          ...
          case !1:
            return 4;
          default:
            var b = Wd.length ? Wd.pop() : X.length;
            X[b] = { tc: 1, value: a };
            return b;
        }
      };
    ...
    function ae(a, b) {
      ...
      c <<= 1;
      if (32 < c - a && $d) return $d.decode(v().slice(a, c));
      c = "";
      for (d = 0; !(d >= b / 2); ++d) {
        var e = ea()[(a + 2 * d) >> 1];
        if (0 == e) break;
    ...
    D.executeNotifiedProxyingQueue = Jc;
    function he(a, b) {
      var c = cd[a];
      void 0 === c && V(b + " has unknown type " + Qd(a));
      return c;
    }
    function ie(a, b) {
      for (var c = Array(a), d = 0; d < a; ++d)
        c[d] = he(B()[(b + 4 * d) >> 2], "parameter " + d);
      return c;
    }
    var je = {};
    function ke(a) {
    ...
    function pe(a) {
      ...
      return function (c, d, e) {
        b[0] = c;
        for (var f = 0; f < a; ++f) {
          var h = he(B()[(d + 4 * f) >> 2], "parameter " + f);
    ...
    var se = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      te = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
    function ue(a) {
      return (re(a.getFullYear()) ? se : te)[a.getMonth()] + a.getDate() - 1;
    }
    function ve(a, b, c, d, e, f, h) {
      if (F) return R(11, 1, a, b, c, d, e, f, h);
      try {
        var l = xc(d);
        if (0 !== (b & 2) && 0 === (c & 2) && 2 !== (l.flags & 2097155))
          throw new N(2);
        if (1 === (l.flags & 2097155)) throw new N(2);
        if (!l.ib.Qb) throw new N(43);
        var m = l.ib.Qb(l, a, e, b, c);
        var n = m.jb;
        z()[f >> 2] = m.yc;
        B()[h >> 2] = n;
        return 0;
      } catch (q) {
        if ("undefined" == typeof Q || "ErrnoError" !== q.name) throw q;
        return -q.ob;
      }
    }
    function we(a, b, c, d, e, f) {
      if (F) return R(12, 1, a, b, c, d, e, f);
      try {
        var h = xc(e);
        if (c & 2) {
    ...
    function R(a, b) {
      var c = arguments.length - 2,
        d = arguments;
      return Be(() => {
        for (var e = De(8 * c), f = e >> 3, h = 0; h < c; h++) {
          var l = d[2 + h];
          ka()[f + h] = l;
        }
        return Ee(a, c, e, b);
    ...
    function Je(a, b, c, d, e) {
      function f() {
        ...
        y.response &&
          G &&
          0 === B()[(a + 12) >> 2] &&
          (da = y.response.byteLength);
        0 < da && ((C = ye(da)), v().set(new Uint8Array(y.response), C));
        B()[(a + 12) >> 2] = C;
        Z(a + 16, da);
        Z(a + 24, 0);
        ...
        w()[(a + 42) >> 1] = y.status;
        y.statusText && Ia(y.statusText, a + 44, 64);
      }
      var h = B()[(a + 8) >> 2];
      if (h) {
        var l = H(h),
        ...
        y.onprogress = (C) => {
          if (T in Ge) {
            var da = G && I && y.response ? y.response.byteLength : 0,
              J = 0;
            0 < da &&
              G &&
              I &&
              ((J = ye(da)), v().set(new Uint8Array(y.response), J));
            B()[(a + 12) >> 2] = J;
            Z(a + 16, da);
            Z(a + 24, C.loaded - da);
            Z(a + 32, C.total);
    ...
    function Oe() {
      if (!Pe) {
        var a = {
          ...
          b;
        for (b in Ne) void 0 === Ne[b] ? delete a[b] : (a[b] = Ne[b]);
        var c = [];
    ...
    var Pe;
    function Qe(a, b) {
      if (F) return R(13, 1, a, b);
      var c = 0;
      Oe().forEach(function (d, e) {
        var f = b + c;
        e = B()[(a + 4 * e) >> 2] = f;
    ...
    function Te(a, b, c, d) {
      ...
      try {
        ...
        if ("undefined" == typeof Q || "ErrnoError" !== I.name) throw I;
        return I.ob;
      }
    }
    function Ue(a, b, c, d, e) {
      if (F) return R(17, 1, a, b, c, d, e);
      try {
        b =
    ...
    function We(a, b) {
      We.Lc || (We.Lc = yb());
      for (var c = 0; c < b; c++) g()[(a + c) >> 0] = We.Lc();
      return 0;
    }
    ...
    function $e(a, b, c, d) {
      ...
      function m(k) {
        var t = k.Ib;
        for (k = new Date(new Date(k.Jb + 1900, 0, 1).getTime()); 0 < t; ) {
          var x = k.getMonth(),
            A = (re(k.getFullYear()) ? Xe : Ye)[x];
          if (t > A - k.getDate())
            (t -= A - k.getDate() + 1),
              k.setDate(1),
              11 > x
      ...
      n = {
        "%a": function (k) {
          return p[k.yb].substring(0, 3);
        },
        "%A": function (k) {
          return p[k.yb];
        },
        "%b": function (k) {
          return r[k.ic].substring(0, 3);
        },
        "%B": function (k) {
          return r[k.ic];
        },
        "%C": function (k) {
          return f(((k.Jb + 1900) / 100) | 0, 2);
        },
        "%d": function (k) {
          return f(k.vc, 2);
        },
        ...
        "%U": function (k) {
          return f(Math.floor((k.Ib + 7 - k.yb) / 7), 2);
        },
        "%V": function (k) {
          var t = Math.floor((k.Ib + 7 - ((k.yb + 6) % 7)) / 7);
          2 >= (k.yb + 371 - k.Ib - 2) % 7 && t++;
          if (t)
            53 == t &&
              ((x = (k.yb + 371 - k.Ib) % 7),
              4 == x || (3 == x && re(k.Jb)) || (t = 1));
            ...
            t = 52;
            var x = (k.yb + 7 - k.Ib - 1) % 7;
            (4 == x || (5 == x && re((k.Jb % 400) - 1))) && t++;
          }
          return f(t, 2);
        },
        "%w": function (k) {
        ...
        "%W": function (k) {
          return f(Math.floor((k.Ib + 7 - ((k.yb + 6) % 7)) / 7), 2);
        },
        "%y": function (k) {
          return (k.Jb + 1900).toString().substring(2);
        },
        "%Y": function (k) {
          return k.Jb + 1900;
        },
    ...
    var uc;
    D.FS_createPath = pc;
    D.FS_createDataFile = rc;
    D.FS_createPreloadedFile = vc;
    D.FS_unlink = gc;
    D.FS_createLazyFile = tc;
    D.FS_createDevice = Xa;
    hd = D.InternalError = gd("InternalError");
    for (var af = Array(256), bf = 0; 256 > bf; ++bf)
      af[bf] = String.fromCharCode(bf);
    nd = af;
    od = D.BindingError = gd("BindingError");
    Cd.prototype.isAliasOf = function (a) {
      if (!(this instanceof Cd && a instanceof Cd)) return !1;
      var b = this.$a.mb.kb,
        c = this.$a.jb,
        d = a.$a.mb.kb;
      for (a = a.$a.jb; b.ub; ) (c = b.Vb(c)), (b = b.ub);
      for (; d.ub; ) (a = d.Vb(a)), (d = d.ub);
      return b === d && c === a;
    };
    Cd.prototype.clone = function () {
      this.$a.jb || pd(this);
      if (this.$a.Sb) return (this.$a.count.value += 1), this;
      var a = Bd,
        b = Object,
        c = b.create,
    ...
    Cd.prototype["delete"] = function () {
      this.$a.jb || pd(this);
      this.$a.Lb && !this.$a.Sb && V("Object already scheduled for deletion");
      rd(this);
      sd(this.$a);
      this.$a.Sb || ((this.$a.rb = void 0), (this.$a.jb = void 0));
    };
    ...
    D.getLiveInheritedInstances = function () {
      var a = [],
        b;
      for (b in yd) yd.hasOwnProperty(b) && a.push(yd[b]);
      return a;
    };
    D.flushPendingDeletes = wd;
    D.setDelayFunction = function (a) {
      xd = a;
      vd.length && xd && xd(wd);
    };
    Ld.prototype.ld = function (a) {
      this.Mc && (a = this.Mc(a));
      return a;
    };
    Ld.prototype.Cc = function (a) {
      this.Cb && this.Cb(a);
    };
    Ld.prototype.argPackAdvance = 8;
    Ld.prototype.readValueFromPointer = ad;
    ...
    Ld.prototype.fromWireType = function (a) {
      function b() {
        return this.bc
          ? Ad(this.kb.Mb, { mb: this.Ad, jb: c, tb: this, rb: a })
          : Ad(this.kb.Mb, { mb: this, jb: a });
      }
      var c = this.ld(a);
      ...
      if (void 0 !== d) {
        if (0 === d.$a.count.value)
          return (d.$a.jb = c), (d.$a.rb = a), d.clone();
        d = d.clone();
        this.Cc(a);
        return d;
      }
      ...
      d = this.ac ? d.bd : d.pointerType;
      var e = td(c, this.kb, d.kb);
      return null === e
        ? b.call(this)
        : this.bc
          ? Ad(d.kb.Mb, { mb: d, jb: e, tb: this, rb: a })
          : Ad(d.kb.Mb, { mb: d, jb: e });
    };
    Pd = D.UnboundTypeError = gd("UnboundTypeError");
    ...
    var cf = [
      ...
      jf = {
        ...
        G: function (a) {
          F ? postMessage({ cmd: "cleanupThread", thread: a }) : sb(a);
        },
        ba: Rc,
        K: Sc,
        oa: Tc,
        ...
        e: function (a) {
          ...
          var c = b.rc,
            d = b.Cb,
            e = b.Ec,
            f = e.map((h) => h.nd).concat(e.map((h) => h.Pd));
          kd([a], f, (h) => {
            var l = {};
            e.forEach((m, n) => {
              var q = h[n],
        ...
        v: function (a, b, c, d, e, f, h, l, m, n, q, p, r) {
          q = U(q);
          f = Od(e, f);
          l && (l = Od(h, l));
          n && (n = Od(m, n));
          ...
          var k = ed(q);
          Ed(k, function () {
            Td("Cannot construct " + q + " due to unbound types", [d]);
          });
          kd([a, b, c], d ? [d] : [], function (t) {
            t = t[0];
            if (d) {
              var x = t.kb;
              var A = x.Mb;
            ...
            t = fd(k, function () {
              if (Object.getPrototypeOf(this) !== G)
                throw new od("Use 'new' to construct " + q);
              if (void 0 === I.Fb)
                throw new od(q + " has no accessible constructor");
              var T = I.Fb[arguments.length];
              if (void 0 === T)
                throw new od(
            ...
            t.prototype = G;
            var I = new Fd(q, t, G, r, x, f, l, n);
            x = new Ld(q, I, !0, !1);
            A = new Ld(q + "*", I, !1, !1);
            var y = new Ld(q + " const*", I, !1, !0);
            ud[a] = { pointerType: A, bd: y };
            Md(k, t);
            return [x, A, y];
          });
        },
        y: function (a, b, c, d, e, f) {
          ...
          kd([], [a], function (l) {
            ...
            void 0 === l.kb.Fb && (l.kb.Fb = []);
            if (void 0 !== l.kb.Fb[b - 1])
              throw new od(
            ...
            l.kb.Fb[b - 1] = () => {
              Td("Cannot construct " + l.name + " due to unbound types", h);
            };
            kd([], h, function (n) {
              n.splice(1, 0, null);
              l.kb.Fb[b - 1] = Vd(m, n, null, e, f);
              return [];
            });
            return [];
          });
        },
        j: function (a, b, c, d, e, f, h, l) {
          var m = Ud(c, d);
          b = U(b);
          f = Od(e, f);
          kd([], [a], function (n) {
            function q() {
              Td("Cannot call " + p + " due to unbound types", m);
            }
            n = n[0];
            var p = n.name + "." + b;
            ...
            var r = n.kb.Mb,
              k = r[b];
            void 0 === k ||
            (void 0 === k.qb && k.className !== n.name && k.Wb === c - 2)
              ? ((q.Wb = c - 2), (q.className = n.name), (r[b] = q))
              : (Dd(r, b, p), (r[b].qb[c - 2] = q));
            kd([], m, function (t) {
              t = Vd(p, t, n, f, h);
              void 0 === r[b].qb
                ? ((t.Wb = c - 2), (r[b] = t))
        ...
        C: function (a, b, c, d, e, f) {
          ...
          Ed(
            a,
            function () {
              Td("Cannot call " + a + " due to unbound types", h);
            },
            b - 1,
          );
          kd([], h, function (l) {
            Md(a, Vd(a, [l[0], null].concat(l.slice(1)), null, e, f), b - 1);
            return [];
          });
        },
        q: function (a, b, c, d, e) {
          ...
          ld(a, {
            ...
            toWireType: c,
            argPackAdvance: 8,
            readValueFromPointer: Zd(b, e, 0 !== d),
            vb: null,
          });
        },
        i: function (a, b, c) {
        ...
        f: function (a, b, c, d, e, f) {
          Zc[a] = { name: U(b), rc: Od(c, d), Cb: Od(e, f), Ec: [] };
        },
        ...
        za: function (a) {
          var b = Ge[a];
          b &&
            (delete Ge[a], 0 < b.readyState && 4 > b.readyState && b.abort());
        },
        sa: function () {
          return !0;
        },
        ...
        t: function (a, b) {
          ...
          e = ne((h, l, m, n) => {
            ...
            h = h[l].apply(h, f);
            for (p = 0; p < a - 1; ++p) c[p + 1].ed && c[p + 1].ed(f[p]);
            if (!d.vd) return d.toWireType(m, h);
          });
          return (oe[b] = e);
        },
        D: function (a, b) {
        ...
        r: function (a, b, c) {
          ...
          for (c >>= 2; (d = v()[b++]); )
            (c += (105 != d) & c),
              ze.push(105 == d ? z()[c] : ka()[c++ >> 1]),
              ++c;
          return pb[a].apply(null, ze);
        },
        H: function () {
          sa ||
            (Ae || (Ae = {}),
        ...
        l: () => performance.timeOrigin + performance.now(),
        P: function () {
        ...
        ga: function (a, b, c) {
          Fe.length = b;
          c >>= 3;
          for (var d = 0; d < b; d++) Fe[d] = ka()[c + d];
          return (0 > a ? pb[-a - 1] : cf[a]).apply(null, Fe);
        },
        $: function (a) {
          var b = v().length;
          a >>>= 0;
        ...
        Aa: function (a, b, c, d, e) {
          ...
          if ("EM_IDB_STORE" === l)
            (l = B()[(h + 84) >> 2]),
              Ke(a, v().slice(l, l + B()[(h + 88) >> 2]), G, y);
          else if ("EM_IDB_DELETE" === l) Me(a, G, y);
          else if (x) {
            if (t) return 0;
            Je(a, k ? C : G, y, I, T);
          } else Le(a, G, t ? y : k ? da : r);
          return a;
        },
        ra: function () {
          throw "unwind";
    ...
    function Sd() {
      return (Sd = D.asm.Ga).apply(null, arguments);
    }
    function ye() {
      return (ye = D.asm.Ha).apply(null, arguments);
    }
    var Fc = (D._fflush = function () {
        return (Fc = D._fflush = D.asm.Ia).apply(null, arguments);
      }),
      Ic = (D._pthread_self = function () {
        return (Ic = D._pthread_self = D.asm.Ja).apply(null, arguments);
      });
    D.__emscripten_tls_init = function () {
      return (D.__emscripten_tls_init = D.asm.Ka).apply(null, arguments);
    };
    function Ib() {
      return (Ib = D.asm.La).apply(null, arguments);
    }
    var Rd = (D.___getTypeName = function () {
      return (Rd = D.___getTypeName = D.asm.Ma).apply(null, arguments);
    });
    D.__embind_initialize_bindings = function () {
      return (D.__embind_initialize_bindings = D.asm.Na).apply(null, arguments);
    };
    function Ec() {
      return (Ec = D.asm.Oa).apply(null, arguments);
    }
    var df = (D.__emscripten_thread_init = function () {
      return (df = D.__emscripten_thread_init = D.asm.Qa).apply(
        null,
        arguments,
      );
    });
    D.__emscripten_thread_crashed = function () {
      return (D.__emscripten_thread_crashed = D.asm.Ra).apply(null, arguments);
    };
    function Ee() {
      return (Ee = D.asm.Sa).apply(null, arguments);
    }
    var ge = (D.__emscripten_proxy_execute_task_queue = function () {
      return (ge = D.__emscripten_proxy_execute_task_queue = D.asm.Ta).apply(
        null,
        arguments,
      );
    });
    function Hc() {
      return (Hc = D.asm.Ua).apply(null, arguments);
    }
    var Nc = (D.__emscripten_thread_exit = function () {
      return (Nc = D.__emscripten_thread_exit = D.asm.Va).apply(
        null,
        arguments,
      );
    });
    function kf() {
      return (kf = D.asm.Wa).apply(null, arguments);
    }
    function Kc() {
      return (Kc = D.asm.Xa).apply(null, arguments);
    }
    function Ce() {
      return (Ce = D.asm.Ya).apply(null, arguments);
    }
    function Lc() {
      return (Lc = D.asm.Za).apply(null, arguments);
    }
    function De() {
      return (De = D.asm._a).apply(null, arguments);
    }
    D.dynCall_ji = function () {
      return (D.dynCall_ji = D.asm.ab).apply(null, arguments);
    };
    D.dynCall_jiji = function () {
      return (D.dynCall_jiji = D.asm.bb).apply(null, arguments);
    };
    D.dynCall_viijii = function () {
      return (D.dynCall_viijii = D.asm.cb).apply(null, arguments);
    };
    D.dynCall_iiiiij = function () {
      return (D.dynCall_iiiiij = D.asm.db).apply(null, arguments);
    };
    D.dynCall_iiiiijj = function () {
      return (D.dynCall_iiiiijj = D.asm.eb).apply(null, arguments);
    };
    D.dynCall_iiiiiijj = function () {
      return (D.dynCall_iiiiiijj = D.asm.fb).apply(null, arguments);
    };
    D.__ZN2MB2NN28LinearDefragmentingAllocator10Allocation4nullE = 70784;
    D.___start_em_js = 356720;
    D.___stop_em_js = 357713;
    function ff(a, b) {
      var c = Ce();
      try {
        S(a)(b);
    ...
    D.addRunDependency = hb;
    D.removeRunDependency = ib;
    D.FS_createPath = pc;
    D.FS_createDataFile = rc;
    D.FS_createPreloadedFile = vc;
    D.FS_createLazyFile = tc;
        ...
        var a = 0,
          ...
          d = (m) => {
            ...
            n.onreadystatechange = () => {
              4 == n.readyState && 0 == --a && b && c("^exit^" + Ea);
            };
