!(function () {
  ...
  class i extends t {
    constructor(e, t) {
      super(i.action), (this.funcName = e), (this.params = t);
    }
  }
  i.action = "invokeFunction";
  class a extends t {
    constructor(e, t) {
  ...
  class o extends t {
    constructor(e, t, s) {
      super(o.action),
        ...
        (this.registeredMetadataCallbacks = s);
    }
  }
  o.action = "createRecognizerRunner";
  class c extends t {
    constructor(e, t) {
      super(c.action),
        (this.recognizerHandles = e),
  ...
  c.action = "reconfigureRecognizerRunner";
  class E extends t {
    constructor() {
      super(E.action);
    }
  ...
  class l extends t {
    constructor(e) {
      super(l.action), (this.frame = e);
    }
    getTransferrables() {
      return [this.frame.imageData.data.buffer];
    }
  }
  l.action = "processImage";
  class _ extends t {
    constructor(e) {
      super(_.action), (this.hardReset = e);
    }
  }
  _.action = "resetRecognizers";
  class I extends t {
    constructor(e) {
      super(I.action), (this.registeredMetadataCallbacks = e);
    }
  }
  I.action = "registerMetadataCallbacks";
  class u extends t {
    constructor(e) {
      super(u.action), (this.detectionOnlyMode = e);
    }
  }
  u.action = "setDetectionOnly";
  class N extends t {
    constructor(e) {
  ...
  class d extends t {
    constructor(e) {
      super(d.action), (this.cameraPreviewMirrored = e);
    }
  }
  d.action = "setCameraPreviewMirrored";
  class O extends t {
    constructor(e) {
      super(O.action), (this.userId = e);
    }
  }
  O.action = "getProductIntegrationInfo";
  class h {
    constructor(e, t, s) {
      (this.success = !0),
        (this.error = null),
  ...
  class f {
    constructor(e, t) {
      (this.isCallbackMessage = !0),
        (this.callbackType = e),
        (this.callbackParameters = t);
    }
  }
  function p(e, t) {
    return (
  ...
  async function y() {
    ...
    return e ? (t ? w.AdvancedWithThreads : w.Advanced) : w.Basic;
  }
  !(function (e) {
    (e.Basic = "BASIC"),
      (e.Advanced = "ADVANCED"),
  ...
  !(function (e) {
    ...
    (function (e) {
      (e.WORKER_HANDLE_UNDEFINED = "Cannot find object with handle: undefined"),
        ...
        (e.SDK_WORKER_LOCATION_INVALID =
          "Setting property 'workerLocation' must be a string!"),
  ...
  const U = {
      licenseTokenStateIncorrect: {
        code: M.LICENSE_UNLOCK_ERROR,
        message: T.LICENSE_TOKEN_STATE_INCORRECT,
      },
      licensePayloadVerificationFailed: {
        code: M.LICENSE_UNLOCK_ERROR,
        message: T.LICENSE_PAYLOAD_VERIFICATION_FAILED,
      },
      licensePayloadCorrupted: {
        code: M.LICENSE_UNLOCK_ERROR,
        message: T.LICENSE_PAYLOAD_CORRUPTED,
      },
      licensePermissionExpired: {
        code: M.LICENSE_UNLOCK_ERROR,
        message: T.LICENSE_PERMISSION_EXPIRED,
      },
      licenseRemoteLocked: {
        code: M.LICENSE_UNLOCK_ERROR,
        message: T.LICENSE_REMOTE_LOCKED,
      },
      licenseNetworkError: { code: M.LICENSE_UNLOCK_ERROR },
      licenseInvalid: { code: M.LICENSE_UNLOCK_ERROR },
    },
    b = {
      imageProcessFailure: {
        message: T.WORKER_IMAGE_PROCESS_FAILURE,
        code: M.WORKER_IMAGE_PROCESS_FAILURE,
      },
      objectInvokeFailure: {
        message: T.WORKER_OBJECT_INVOKE_FAILURE,
        code: M.WORKER_OBJECT_INVOKE_FAILURE,
      },
      runnerDeleteFailure: {
        message: T.WORKER_RUNNER_DELETE_FAILURE,
        code: M.WORKER_RUNNER_DELETE_FAILURE,
      },
      runnerDeleted: {
        message: T.WORKER_RUNNER_DELETED,
        code: M.WORKER_RUNNER_DELETED,
      },
      runnerReconfigureFailure: {
        message: T.WORKER_RUNNER_RECONFIGURE_FAILURE,
        code: M.WORKER_RUNNER_RECONFIGURE_FAILURE,
      },
      runnerMissing: {
        message: T.WORKER_RUNNER_MISSING,
        code: M.WORKER_RUNNER_MISSING,
      },
      runnerCreationFailure: {
        message: T.WORKER_RUNNER_CREATION_FAILURE,
        code: M.WORKER_RUNNER_CREATION_FAILURE,
      },
      runnerExists: {
        message: T.WORKER_RUNNER_EXISTS,
        code: M.WORKER_RUNNER_EXISTS,
      },
      recognizerCreationFailure: {
        message: T.WORKER_RECOGNIZER_CREATION_FAILURE,
        code: M.WORKER_RECOGNIZER_CREATION_FAILURE,
      },
      functionInvokeFailure: {
        message: T.WORKER_FUNCTION_INVOKE_FAILURE,
        code: M.WORKER_FUNCTION_INVOKE_FAILURE,
      },
      wasmInitMissing: {
        message: T.WORKER_WASM_INIT_MISSING,
        code: M.WORKER_WASM_INIT_MISSING,
      },
      wasmLoadFailure: {
        message: T.WORKER_WASM_LOAD_FAILURE,
        code: M.WORKER_WASM_LOAD_FAILURE,
      },
      handleUndefined: {
        message: T.WORKER_HANDLE_UNDEFINED,
        code: M.WORKER_HANDLE_UNDEFINED,
      },
      integrationInfoFailure: {
        message: T.WORKER_INTEGRATION_INFO_FAILURE,
        code: M.WORKER_INTEGRATION_INFO_FAILURE,
      },
    };
  var k, K;
  !(function (e) {
  ...
  const P = "https://baltazar.microblink.com/api/v1/status/check";
  function W(e) {
    return {
      licenseId: e.licenseId,
      licensee: e.applicationId,
  ...
  async function v(e, t) {
    try {
      ...
      if (s.ok) {
        ...
        return t.submitServerPermission(e);
      }
      return {
        status: G.NetworkError,
        lease: 0,
        networkErrorDescription: "Server responded with status " + s.status,
      };
    } catch (e) {
      return {
        status: G.NetworkError,
        lease: 0,
        networkErrorDescription: "Unexpected error: " + JSON.stringify(e),
      };
    }
  }
  function V(e) {
    return e === w.AdvancedWithThreads;
  }
  !(function (e) {
    (e[(e.Ok = 0)] = "Ok"),
  ...
  new (class {
      ...
      (this.context = self),
        ...
        (this.context.onmessage = (e) => {
          ...
          switch (t.action) {
            ...
            default:
              throw new F({
                code: M.WORKER_MESSAGE_ACTION_UNKNOWN,
                message: "Unknown message action: " + JSON.stringify(t.action),
              });
          }
        });
    }
    ...
    notifyError(e, t) {
      this.context.postMessage(new h(e.messageID, !1, t));
    }
    notifySuccess(e) {
      this.context.postMessage(new h(e.messageID, !0, null));
    }
    notifyInitSuccess(e, t, s) {
      this.context.postMessage(new S(e.messageID, !0, t, s));
    }
    unwrapParameters(e) {
      const t = [];
      for (const s of e.params) {
        ...
        s.type === r.Recognizer
          ? ((n = this.objects[n]),
            void 0 === n && this.notifyError(e, new F(b.handleUndefined)))
          : s.type === r.RecognizerSettings && (n = this.restoreFunctions(n)),
          t.push(n);
      }
      return t;
    }
    restoreFunctions(e) {
      ...
      for (const s of t) {
        ...
        "object" == typeof t &&
          ...
          t.type === r.Callback &&
          (e[s] = (...e) => {
            const s = new f(n.recognizerCallback, [t.parameter].concat(e));
      ...
      if ("object" == typeof e) {
        ...
        for (const r of t) {
          ...
          t instanceof ImageData
            ? s.push(t.data.buffer)
            : t instanceof Uint8Array
              ? s.push(t.buffer)
              : null !== t &&
                "object" == typeof t &&
                s.push(...this.scanForTransferrables(t));
        }
        return s;
      }
      return [];
      ...
      if (this.wasmModule) {
        ...
        switch (s.status) {
          ...
          case G.RemoteLock:
            ...
            break;
          case G.NetworkError:
          case G.PayloadSignatureVerificationFailed:
          case G.PayloadCorrupted:
            e
              ? (console.warn(
              ...
              : console.error(
                  "Problem with obtaining server permission. " + G[s.status],
                );
            break;
          case G.IncorrectTokenState:
          case G.PermissionExpired:
            console.error("Internal error: " + G[s.status]);
        }
        return s.status;
      }
      return (
        ...
        G.IncorrectTokenState
      );
    }
    willSoonExpire() {
      if (this.lease) {
        if (
          this.wasmModule.getActiveLicenseTokenInfo().unlockResult === k.Valid
        ) {
    ...
    async calculateWasmType(e) {
      return null !== e.wasmType ? e.wasmType : await y();
    }
    calculateEngineLocationPrefix(e, t) {
      ...
      return (
        e.allowHelloMessage && console.log("Engine location prefix is:", s), s
      );
    }
    async processInitMessage(e) {
      const t = await this.calculateWasmType(e),
        s = this.calculateEngineLocationPrefix(e, t);
      let r = { locateFile: (e) => p(s, e), noExitRuntime: !0 };
      e.registerLoadCallback &&
        (r = Object.assign(r, {
          setStatus: (e) => {
            const t = new D(
              (function (e) {
      ...
      try {
        const n = p(s, e.wasmModuleName + ".js");
        V(t) &&
          (r = (function (e, t, s) {
            return (
              t && t > 0 && (e = Object.assign(e, { allowedThreads: t })),
              null !== s && (e = Object.assign(e, { mainScriptUrlOrBlob: s })),
              e
            );
          })(r, e.numberOfWorkers, n)),
          importScripts(n);
        (0, self[e.wasmModuleName])(r).then(
          async (s) => {
            V(t) &&
              (e.allowHelloMessage &&
                console.log("Waiting for thread workers to boot..."),
              await (async function (e) {
                e.threadWorkersReadyPromise &&
                  (await e.threadWorkersReadyPromise);
              })(s));
            const r = await (async function (e, t, s, r) {
              const n = r.initializeWithLicenseKey(e, s, t);
              switch (n.unlockResult) {
                case k.Invalid:
                  return {
                    error: new F(
                      { ...U.licenseInvalid, message: n.licenseError },
                      { type: K.LicenseTokenStateInvalid },
                    ),
                  };
                case k.Valid:
                  return {
                    ...
                    showOverlay:
                      ((i = n.isTrial),
                      (a = n.allowRemoveDemoOverlay),
                      (o = n.allowRemoveProductionOverlay),
                      !((i && a) || (!i && o))),
                  };
                case k.RequiresServerPermission: {
                  ...
                  switch (e.status) {
                    case G.Ok:
                      return { error: null, lease: e.lease };
                    case G.NetworkError: {
                      let t = "";
                      return (
                        e.networkErrorDescription &&
                          (t = " " + e.networkErrorDescription),
                        {
                          error: new F(
                            {
                              ...U.licenseNetworkError,
                              message:
                    ...
                    case G.RemoteLock:
                      return {
                        error: new F(U.licenseRemoteLocked, {
                          type: K.RemoteLock,
                        }),
                        lease: e.lease,
                      };
                    case G.PermissionExpired:
                      return {
                        error: new F(U.licensePermissionExpired, {
                          type: K.PermissionExpired,
                        }),
                        lease: e.lease,
                      };
                    case G.PayloadCorrupted:
                      return {
                        error: new F(U.licensePayloadCorrupted, {
                          type: K.PayloadCorrupted,
                        }),
                        lease: e.lease,
                      };
                    case G.PayloadSignatureVerificationFailed:
                      return {
                        error: new F(U.licensePayloadVerificationFailed, {
                          type: K.PayloadSignatureVerificationFailed,
                        }),
                        lease: e.lease,
                      };
                    case G.IncorrectTokenState:
                      return {
                        error: new F(U.licenseTokenStateIncorrect, {
                          type: K.IncorrectTokenState,
                        }),
                        lease: e.lease,
                      };
                  }
              ...
              var i, a, o;
            })(e.licenseKey, e.allowHelloMessage, e.userId, s);
            null === r.error
              ? ((this.wasmModule = s),
                r.lease
                  ? this.registerHeartBeat(r.lease)
                  : this.unregisterHeartBeat(),
                this.notifyInitSuccess(e, !!r.showOverlay, t))
              : this.notifyError(e, r.error);
          },
          (t) => {
            this.notifyError(e, new F(b.wasmLoadFailure, t));
          },
        );
      } catch (t) {
        this.notifyError(e, new F(b.wasmLoadFailure, t));
    ...
    processInvokeFunction(e) {
      if (null === this.wasmModule)
        return void this.notifyError(e, new F(b.wasmInitMissing));
      const t = e.funcName,
        s = this.unwrapParameters(e);
      try {
        const r = this.wasmModule[t](...s);
        this.context.postMessage(new g(e.messageID, r));
      } catch (t) {
        this.notifyError(e, new F(b.functionInvokeFailure, t));
      }
    }
    processCreateNewRecognizer(e) {
      ...
      const t = e.className,
        s = this.unwrapParameters(e);
      try {
        const r = new this.wasmModule[t](...s),
          n = this.getNextObjectHandle();
        (this.objects[n] = r), this.context.postMessage(new C(e.messageID, n));
      } catch (t) {
        this.notifyError(e, new F(b.recognizerCreationFailure, t));
      }
    }
    getRecognizers(e) {
      const t = [];
    ...
    async processCreateRecognizerRunner(e) {
      if (null === this.wasmModule)
        this.notifyError(e, new F(b.wasmInitMissing));
      else if (null !== this.nativeRecognizerRunner)
        this.notifyError(e, new F(b.runnerExists));
      else {
        this.setupMetadataCallbacks(e.registeredMetadataCallbacks);
        try {
          if (this.willSoonExpire()) {
            const t = await this.obtainNewServerPermission(!1);
            if (t !== G.Ok) {
              const s = G[t];
              return void this.notifyError(
                ...
                new F(
                  {
                    code: M.WORKER_LICENSE_UNLOCK_ERROR,
                    message:
          ...
          (this.nativeRecognizerRunner = new this.wasmModule.RecognizerRunner(
            t,
            e.allowMultipleResults,
            this.metadataCallbacks,
          )),
            this.notifySuccess(e);
        } catch (t) {
          this.notifyError(e, new F(b.runnerCreationFailure, t));
        }
      }
    }
    processReconfigureRecognizerRunner(e) {
      if (null === this.wasmModule)
        ...
        this.notifyError(e, new F(b.runnerMissing));
      else
        try {
          const t = this.getRecognizers(e.recognizerHandles);
          ...
          this.notifyError(e, new F(b.runnerReconfigureFailure, t));
        }
    }
    processDeleteRecognizerRunner(e) {
      if (null !== this.nativeRecognizerRunner)
        try {
          ...
          this.notifyError(e, new F(b.runnerDeleteFailure, t));
        }
      else this.notifyError(e, new F(b.runnerDeleted));
    }
    wrapFunctions(e, t) {
      ...
      for (const e of n) {
        if ("function" == typeof s[e]) {
          s[e] = {
            parameter: { recognizerHandle: t, callbackName: e },
            type: r.Callback,
          };
        }
      }
    ...
    processInvokeObject(e) {
      try {
        const t = e.objectHandle,
          s = e.methodName,
          r = this.unwrapParameters(e),
          n = this.objects[t];
        if (void 0 === n)
          this.notifyError(
            e,
            new F({
              message: "Cannot find object with handle: " + t,
              code: M.WORKER_HANDLE_UNDEFINED,
            }),
          );
        else {
          const i = this.wrapFunctions(n[s](...r), t),
            a = this.scanForTransferrables(i);
          "delete" === s && delete this.objects[t],
            this.context.postMessage(new g(e.messageID, i), a);
        }
      } catch (t) {
        this.notifyError(e, new F(b.objectInvokeFailure, t));
      }
    }
    processImage(e) {
      if (null !== this.nativeRecognizerRunner)
        try {
          let t = e.frame;
          const s = this.nativeRecognizerRunner.processImage(t);
          this.context.postMessage(new m(e.messageID, s), [
            t.imageData.data.buffer,
          ]),
            (t = null);
        } catch (t) {
          this.notifyError(e, new F(b.imageProcessFailure, t));
        }
      else this.notifyError(e, new F(b.imageProcessFailure));
    }
    resetRecognizers(e) {
      if (null !== this.nativeRecognizerRunner)
        try {
          this.nativeRecognizerRunner.resetRecognizers(e.hardReset),
            this.notifySuccess(e);
        } catch (t) {
          this.notifyError(e, new F(b.imageProcessFailure, t));
        }
    ...
    setDetectionOnly(e) {
      if (null !== this.nativeRecognizerRunner)
        try {
          this.nativeRecognizerRunner.setDetectionOnlyMode(e.detectionOnlyMode),
            this.notifySuccess(e);
        } catch (t) {
          this.notifyError(e, new F(b.imageProcessFailure, t));
        }
    ...
    registerClearTimeoutCallback(e) {
      if (null !== this.nativeRecognizerRunner) {
        this.clearTimeoutCallback = e.callbackNonEmpty
          ? {
              onClearTimeout: () => {
                const e = new f(n.clearTimeoutCallback, []);
                this.context.postMessage(e);
              },
            }
          : null;
        ...
        try {
          const t = this.wasmModule.getActiveLicenseTokenInfo(),
            s = {
              ...
              licensee: t.licensee,
              productName: t.sdkName,
              productVersion: t.sdkVersion,
              platform: "Browser",
              device: self.navigator.userAgent,
              packageName: t.packageName,
            };
          this.context.postMessage(new A(e.messageID, s));
        } catch (t) {
          this.notifyError(e, new F(b.objectInvokeFailure, t));
        }
      else this.notifyError(e, new F(b.wasmInitMissing));
    }
  })();
})();
