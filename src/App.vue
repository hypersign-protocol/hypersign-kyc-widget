  ...
  async created() {
    ...
    if (WidgetConfig) {
      ...
      let steps = [
        ...
        { "id": 5, "isActive": false, "stepName": "ZkProofs", "name": "Generate Proofs", "previous": 4, "isEnabled": false, stepTitle: "Generate zkProof", logo: "proof.png" },
        { "id": 6, "isActive": false, "stepName": "OnChainId4", "name": "On Chain Identity", "previous": 5, "isEnabled": false, stepTitle: "Generate zkProof & Mint your on-chain Identity", logo: "proof.png" },
